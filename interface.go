...
// The client can send the STK in subsequent handshakes to prove ownership of his IP address.
type STK struct {
...
type Config struct {
	...
	// If true is returned, a source address validation is performed
	// If not set, it verifies that the address matches, and that the STK was issued within the last 24 hours
	// This option is only valid for the server.
	VerifySourceAddress func(clientAddr net.Addr, stk *STK) bool
}
